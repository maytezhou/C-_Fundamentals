...
int getValidAccountNumber(fstream & );// added
void printAllRecords(fstream & );// added
...
void createTextFile( fstream & readFromFile){
    ...
    outPrintFile << left << setw(10) << "Account" << setw(16)
       << "Last Name" << setw(11) << "Fist Name" << right
...
void printAllRecords ( fstream & readFromFile){// function added
...
void updateRecord ( fstream & updateFile){
 ...
 int getValidAccountNumber(fstream  & readFromFile){// added

     readFromFile.seekg(0);// preparing for reading binary file
     int smallAccountNumber;
     ClientData client;
     readFromFile.read(reinterpret_cast <char*> (&client), sizeof(ClientData));
     smallAccountNumber= client.getAccountNumber();
     ...
     smallAccountNumber++;
     smallAccountNumber = (smallAccountNumber >= 1 && smallAccountNumber <= 100 ) ? smallAccountNumber : 0 ;
  return smallAccountNumber;
